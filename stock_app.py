...
def get_stock_report():
    ...
    prompt = """
    너는 전문 주식 애널리스트야. 반드시 구글 검색을 사용하여 오늘 날짜의 가장 최신 뉴스 및 주식 시장(미장/국장 상승·하락 여부) 실제 팩트를 확인한 후 아래 항목을 작성해. 사실과 다른 내용을 지어내면 절대 안 돼.
    ...
    4. 🎯 섹터별 대장종목 (최대 3개) 및 구체적인 추천 이유
    """
    
    response = client.models.generate_content(
    model='gemini-2.0-flash-002', # 혹은 'gemini-2.0-flash'
    contents=prompt,
